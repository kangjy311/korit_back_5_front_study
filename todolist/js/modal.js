//      테스트
// window.onload = () => {     // onload 페이지 전체가 켜지면
//     // const day = ["일", "월", "화", "수", "목", "금", "토"];
//     // // console.log(new Date());
//     // let now = new Date();
//     // console.log(now.getFullYear());
//     // console.log(now.getMonth() + 1);    // 자바스크립트는 0월로 시작해서 +1
...
//     //객체를 제이슨 변환 -> stringify  , 제이슨을 객체로 변환 -> parse
// }   

window.onkeyup = (e) => {   // window: 전체영역
    // console.log(e.keyCode);
    if(e.keyCode === 27) {      // 27: esc키
        handleCancelClick();
    }
}
